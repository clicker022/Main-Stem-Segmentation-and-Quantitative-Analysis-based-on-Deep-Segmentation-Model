...
class DataAugmentForObjectDetection():
    def __init__(self, change_light_rate=2,
                 add_noise_rate=0.6, random_point=-1, flip_rate=-1, shift_rate=-1, rand_point_percent=0.03,
...
if __name__ == '__main__':
    ...
    # parser.add_argument('D:\All_Codes\ImgEnhanceTools\DataAugForObjectSegmentation\data', type=str, default='data')
    # parser.add_argument('D:\All_Codes\ImgEnhanceTools\DataAugForObjectSegmentation\savedata', type=str, default='data2')
        ...
        for file in files:
            if file.endswith('jpg') or file.endswith('png'):
                ...
                while cnt < need_aug_num:  # 继续增强
                    ...
                    img_name = '{}_{}{}'.format(_file_prefix, 'flip', _file_suffix)  # 图片保存的信息
                    ...
                    toolhelper.save_json('{}_{}.json'.format(_file_prefix, 'flip'),
